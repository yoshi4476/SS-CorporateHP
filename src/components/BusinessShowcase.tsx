...
// 大きさに強弱をつけ、1枚 → 2枚 → 3枚 の順に並べて視線を落とす。

const SPAN = ["lg:col-span-6", "lg:col-span-3", "lg:col-span-3", "lg:col-span-2", "lg:col-span-2", "lg:col-span-2"];
const HEIGHT = ["h-[420px] md:h-[460px]", "h-[340px]", "h-[340px]", "h-[300px]", "h-[300px]", "h-[300px]"];
