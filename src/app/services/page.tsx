...
const PRODUCTS = [
  ...
  // 経理BPOを引き受けるための自社システム。売り物のSaaSではなく、
  // 当社の担当者が使う基盤なので、価格ではなく用途を出す
  {
    href: "/services/keiri-bpo",
    en: "Accounting BPO Platform — 自社基盤",
    name: "経理BPO基盤",
    catch: "記帳から給与・年末調整まで、1か所で引き受けるための基盤",
  ...
  // 広告運用を引き受けるための自社システム。こちらも売り物ではなく基盤
  {
    ...
    en: "Ad Operations Platform — 自社基盤",
    name: "広告運用の管理システム",
